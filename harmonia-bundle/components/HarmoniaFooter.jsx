    ...
    <footer className="relative border-white/10 border-t">
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8 py-16">
        <div className="text-center space-y-8">
          <h2 className="md:text-6xl text-4xl font-light text-white tracking-tight font-manrope">
            Ready to revolutionize creator payments?
          </h2>
          <p className="text-lg text-neutral-300 max-w-2xl mx-auto font-sans">
            Join Swan and experience the future of trustless creator-brand collaborations. No more payment delays, no more disputes.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            ...
            <a href="#" className="group inline-flex items-center gap-2 rounded-full bg-white/10 px-6 py-3 text-sm font-medium text-white ring-1 ring-white/15 hover:bg-white/15 transition-colors font-sans">
              Join Waitlist
              <ArrowRightIcon />
            </a>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8 py-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium tracking-tight text-white font-sans">Swan</span>
            </div>

            <p className="text-sm text-neutral-400 font-sans">
              Powered by Harmonia Suite
            </p>

            <div className="flex items-center gap-4">
              <a href="mailto:hello@swan.com" className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1.5 text-xs font-medium text-white ring-1 ring-white/15 hover:bg-white/15 font-sans">
                <MailIcon />
                hello@swan.com
              </a>
            </div>
