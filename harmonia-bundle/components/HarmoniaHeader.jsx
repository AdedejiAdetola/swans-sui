      ...
      <div className="max-w-7xl md:px-8 mr-auto ml-auto pr-6 pl-6">
        <div className="flex pt-5 pb-5 items-center justify-between">
          ...
          <a href="/" className="flex items-center gap-3">
            <Logo />
            <span className="text-lg font-medium text-white tracking-tight">Swan</span>
          </a>

          {/* Connect Wallet Button */}
          <div className="hidden md:block">
            <button className="inline-flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-sm font-medium text-white ring-1 ring-white/15 hover:bg-white/15 transition">
              <SparklesIcon />
              Connect Wallet
            </button>
          </div>
          ...
          <div className="md:hidden">
            <div className="mt-2 rounded-2xl bg-neutral-900/70 ring-1 ring-white/10 backdrop-blur">
              <div className="p-4 grid gap-2">
                <button className="inline-flex items-center justify-center gap-2 rounded-xl bg-white/10 px-4 py-2 text-sm font-medium text-white ring-1 ring-white/15 hover:bg-white/15 font-sans">
                  <SparklesIcon />
                  Connect Wallet
                </button>
              </div>
