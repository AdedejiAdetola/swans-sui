...
export function BalanceChecker({ address, className = '' }: BalanceCheckerProps) {
  ...
  if (isLoading) {
    return (
      <div className={`flex items-center space-x-2 text-sm text-neutral-400 ${className}`}>
  ...
  if (hasInsufficientBalance) {
    return (
      <div className={`bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 text-sm ${className}`}>
        <div className="flex items-start space-x-2">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="font-medium text-amber-300">Low SUI Balance</h3>
            <div className="mt-1 text-amber-200/80">
              <p>
                Balance: <span className="font-medium text-amber-200">{suiBalance.toFixed(4)} SUI</span>
              </p>
              <p className="mt-1">
                ...
                <a
                  ...
                  className="font-medium underline hover:text-amber-100 text-amber-200"
                >
                  Sui Devnet Faucet
                </a>
              </p>
  ...
  return (
    <div className={`text-sm text-emerald-400 flex items-center space-x-1 ${className}`}>
